...
def main(args):
    ...
    if args.keep_training_model_path != None:
        ...
        model = PPO('MlpPolicy', env, learning_rate =3e-4, n_steps = 300, batch_size =300, policy_kwargs=policy_kwargs,verbose=1)
    ...
    model.learn(total_timesteps=args.epochs*300, log_interval=10)
